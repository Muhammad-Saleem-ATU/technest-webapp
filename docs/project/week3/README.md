...
This is the current state of the project at the end of week 3. All five pages are
fully styled. The js/ folders exist but are empty at this stage — JavaScript will
be added from week 4 onwards.
...
but no JavaScript functionality has been added yet.
